...
type Value struct {
	typ   string  // used to determin the data type
	str   string  // value of the string received
	num   int     // value of the integer
	bulk  string  // store the string received from bulk
	array []Value // all values received from arrays
}
